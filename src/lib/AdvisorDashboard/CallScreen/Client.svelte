...
<div class="client" transition:slide={{duration: 200}}>
    <div class="header" on:click={() => expanded = !expanded}>
        ...
        <h3>
            ...
            <span>
                ...
                Unsure of match
                {:else}
                {Math.round(client.similarity / client.similarityMax * 100)}% match ({client.similarity}/{client.similarityMax} traits in common)
                {/if}
            </span>
        </h3>
